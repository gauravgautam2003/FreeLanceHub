        ...
        <>
            <nav className="h-[70px] relative w-full  md:px-16 flex items-center md:justify-between lg:justify-between justify-evenly  z-20 bg-white text-gray-700 shadow-[0px_4px_25px_0px_#0000000D] transition-all" >
                ...
                <div className='flex justify-center items-center gap-1 cursor-pointer'>
                    <SiBackendless className='text-purple-800 text-4xl font-bold' />
                ...
                <div className='flex gap-4 lg:gap-4 items-center justify-center'>
                    ...
                    <div className='flex gap-0.5'>
                        <button type="button" className="bg-white text-gray-600 border border-gray-300 md:inline hidden text-sm hover:bg-gray-50 active:scale-95 transition-all w-20 h-8  rounded-lg">
                            Sign Up
                        </button>


                        <button type="button" className="bg-purple-800 text-white border border-gray-300 md:inline hidden text-sm hover:bg-purple-600 active:scale-95 transition-all w-35 h-8 rounded-lg">
                            Join  as Developer
                        </button>
                    </div>
                ...
                <div className={`mobile-menu absolute top-[70px] right-0 opacity-90    w-3xs h-screen md:w-[400px] bg-gray-200 p-6  md:hidden ${open ? "block" : "hidden"}`}>
                    ...
                    <div className='flex flex-col mt-5 gap-2'>
                        <button type="button" className="bg-white text-gray-600 border border-gray-300 md:inline text-sm hover:bg-gray-50 active:scale-95 transition-all  h-8 rounded-lg w-full">
                            Sign Up
                        </button>
                        <button type="button" className="bg-purple-800 text-white border border-gray-300 md:inline text-sm hover:bg-purple-600 active:scale-95 transition-all w-full h-8 rounded-lg">
                            Join  as Developer
                        </button>
                    </div>
                </div>
